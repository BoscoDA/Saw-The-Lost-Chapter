...
namespace Final_Game_Project.Scenes
{
    class MainMenu : Scene
    {
        ...
        public override void Run()
        {
            ...
            TextAnimationUtils.Blink(Art_Assets.TitleArt, 3);
            Clear();
            string title = Art_Assets.TitleArt;
            string[] mainMenuOptions = { "Play", "Credits", "Exit" };
            Menu mainMenu = new Menu(title, mainMenuOptions);
